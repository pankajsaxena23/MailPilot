...
def send_email_campaign(subject, body, recipients, delay_seconds=1.0, max_retries=2):
    ...
    """
    sender_email = os.environ.get("SMTP_EMAIL") or os.environ.get("GMAIL_SENDER_EMAIL")
    sender_password = os.environ.get("SMTP_PASSWORD") or os.environ.get("GMAIL_APP_PASSWORD")
